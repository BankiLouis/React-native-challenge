...
export default {
  ...
  tabActiveBgColor: (Platform.OS === 'ios') ? '#5C4196' : undefined,

  // Header
  iosToolbarBtnColor: '#5C4196',
  toolbarDefaultBg: (Platform.OS === 'ios') ? '#5C4196' : '#5C4196', 
  ...
  // tabFontSize: 15,
  // tabTextColor: '#fff',
  tabBgColor: (Platform.OS === 'ios') ? '#5C4196' : '#5C4196',
  tabFontSize: 15,
